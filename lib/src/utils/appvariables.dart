class AppVariables {
  // ตัวแปรที่สามารถเปลี่ยนแปลงค่าได้
  ...
  static DateTime? searchNotiDateStart = null;
  static DateTime? searchNotiDateEnd = null;

  static String searchDetail = "";
  static String GoldPrice = "";
  static String SavingId = "";
  static String PawnId = "";
  static String PawnBranch = "";
